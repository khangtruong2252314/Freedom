...
func main()
	begin
		...
		"""
		expect = 'Program([FuncDecl(Id(main), [], Block([VarDecl(Id(a), None, var, ArrayLit(ArrayLit(ArrayLit(ArrayLit(ArrayLit(ArrayLit()))))))]))])'
		self.assertTrue(TestAST.test(inputs, expect, 401))
